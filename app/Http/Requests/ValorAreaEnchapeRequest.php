...
class ValorAreaEnchapeRequest extends FormRequest
{
    public function authorize(): bool
    {
        return Gate::allows('configuracion.saveValorAreaEnchape');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.id' => ['nullable', 'integer', 'exists:valor_area_enchape,id'],
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            $valoresExistentes = DB::table('valor_area_enchape')
                ->where('año', $año)
