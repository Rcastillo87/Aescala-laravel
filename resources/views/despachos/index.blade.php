        ...
        <form method="POST" id="formDespachos" action="{{ route('despachos.save') }}">
            ...
            <div class="flex flex-col lg:flex-row gap-4">
                ...
                <div class="w-full lg:w-1/2 space-y-4 p-3 border-2 border-gray-400 rounded-2xl">
                    ...
                    <div>
                        <input class="hidden" id="arrayMateriales" value='@json($materiales)'>
                ...
                <div class="w-full h-full lg:w-1/2 text-center border-2 border-gray-400 rounded-2xl">
                    <p id="tituloMateriales" class="font-bold text-xl mb-3"></p>
...
@section('scripts')
    <script src="{{ asset('js/despachos/index.js') }}?v={{ filemtime(public_path('js/despachos/index.js')) }}"></script>
@endsection