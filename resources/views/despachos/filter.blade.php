<div id="accordion-open" data-accordion="open">
        ...
        <div id="accordion-open-body-1" class="hidden" aria-labelledby="accordion-open-heading-1">
            <div class="p-1 border border-b-1 border-gray-200">
             <form method="GET" action="{{route("despachos.indexDespachos")}}">
                ...
                <div class="flex flex-wrap gap-1">
                    ...
                    <div class="p-2 shrink-0 w-[40]">
                        <x-input-label for="id_userSerch" :value="__('Quien recibe el despacho')" />
                        <x-select-input 
                            name="id_userSerch" 
                    ...
                    <div class="p-2 shrink-0 w-[50]">
                        <x-input-label for="id_material" :value="__('Material')" />
                        <x-select-input 
