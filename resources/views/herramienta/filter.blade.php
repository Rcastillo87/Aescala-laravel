<div id="accordion-open" class="mb-4 shadow-md" data-accordion="open">
        ...
        <div id="accordion-open-body-1" class="hidden" aria-labelledby="accordion-open-heading-1">
            <div class="p-1 border border-b-1 border-gray-200">
             <form method="GET" action="{{route("herramienta.index")}}">
                <div class="flex flex-wrap gap-1">
                    <div class="p-2 shrink-0 w-[40]">
                        <x-input-label for="nombre_herramienta" :value="__('Nombre Herramienta')" />
                        <x-text-input id="nombre_herramienta" class="block mt-1 w-full" type="text" name="nombre_herramienta" :value="Request('nombre_herramienta')" 
                         autofocus />
                    </div>
                    <div class="p-2 shrink-0 w-[40]">
                        <x-input-label for="referencia" :value="__('Referencia')" />
                        <x-text-input id="referencia" class="block mt-1 w-full" type="text" name="referencia" :value="Request('referencia')" />
                    </div>
                    <div class="p-2 shrink-0 w-[40]">
                        <x-input-label for="marca" :value="__('Marca')" />
                        <x-text-input id="marca" class="block mt-1 w-full" type="text" name="marca" :value="Request('marca')" />
                    </div>
