<x-guest-layout>
    <div class="flex items-center justify-center min-h-screen w-full bg-gray-100 px-4">
        <div class="bg-white rounded-lg shadow-lg p-8 max-w-5xl w-full text-center relative">
            ...
            <!-- Título -->
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Otro Si N° {{ $otroSi->numero }} Del Proyecto: {{ $otroSi->proyecto->nombre_proyecto }}</h1>

            <!-- Subtítulo -->
            <p class="text-center text-gray-600 text-sm">
                Términos, Condiciones y Obligaciones del Otro Si
            </p>
