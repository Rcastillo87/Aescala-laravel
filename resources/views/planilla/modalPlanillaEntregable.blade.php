<!-- Modal -->
<x-modal name="modalPlanillaEntregable-modal" maxWidth="6xl" :closeOnOutsideClick="false" :closeOnEscape="false">
    <div class="p-6 space-y-6">

        {{-- Header --}}
        <div class="border-b pb-2">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">
                Selecciona el tipo y adicione los ítems que desea agregar a la planilla
            </h2>
        </div>
        ...
        <form id="formPlanillaEntregable" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-2 items-end">
                ...
                <div class="md:col-span-2">
                    <x-input-label for="id_tipo" :value="__('Tipo *')" />
                    <x-select-input
                        name="id_tipo"
                        id="id_tipo"
                        :options="$tipos"
            ...
            <div class="flex justify-between items-center pt-4 border-t">
                <button type="button"
                    x-on:click="$dispatch('close-modal', 'modalPlanillaEntregable-modal')"
