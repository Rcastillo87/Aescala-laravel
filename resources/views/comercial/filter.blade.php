            ...
            <div class="p-1 border border-b-1 border-gray-200">
             <form method="GET" action="{{route("comercial.index")}}">
                ...
                <div class="flex flex-wrap gap-1">
                    ...
                    <div class="p-2 shrink-0 w-[40]">
                        <x-input-label for="telefono_cliente" :value="__('Telefono')" />
                        <x-text-input id="telefono_cliente" class="block mt-1 w-full" type="text" name="telefono_cliente" :value="Request('telefono_cliente')" 
                         autofocus />
                    </div>
