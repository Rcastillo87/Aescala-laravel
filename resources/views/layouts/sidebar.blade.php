                        ...
                        @if (Auth::user()->isCartera || Auth::user()->isAdmin)
                            <li>
                                <a href="{{ route('cartera.index') }}"
                                    class="flex hidden items-center p-2 font-normal text-white hover:text-orange-500 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group transition duration-75 pl-6">
            ...
            @if (Auth::user()->isAdmin)
                <li>
                    <a href="{{ route('user.index') }}"
                        class="flex items-center p-2 font-normal text-white hover:text-orange-500 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="shrink-0 w-6 h-6 transition duration-75 dark:text-gray-400 dark:group-hover:text-white"
